function Resize (block, pivot)
{
  ...
  this.target.mousemove      (this.hovering.scope(this));
  this.target.mouseout       (this.mouseout.scope(this));
...
Resize.prototype.startResizing =
  function startResizing (x, y, r)
  {
    ...
    if (this.moveToTop) this.target.css("z-index", "100");
...
Resize.prototype.stopResizing =
  function stopResizing ()
  {
    ...
    this.onStopE.map(function (e) { e.call(this, this.geom); }.scope(this));
  };
...
Resize.prototype.resize =
  function resize (x, y)
  {
    ...
    this.onResizeE.map(function (e) { e.call(this, this.block.geom); }.scope(this));
  };

Resize.prototype.adjust =
  function adjust (g)
  {
    this.block.adjust(this.onStop(g, this.block.geom));
